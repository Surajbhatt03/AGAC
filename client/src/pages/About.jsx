  ...
  return (
    <>
      ...
      <section class="about-us">
        ...
        <div class="container-y">
          ...
          <div class="right-section">
            <h2>What is AGAL?</h2>
            <p>
              Welcome to the Aquatech Genomic Agriculture Center (AGAL), where
              we merge artificial intelligence with aquaculture.
            </p>
            <p>
              To develop innovative solutions for sustainable food production
              and environmental conservation. AGAL focuses on genomic research,
              ...
              instrumental in AGAL's establishment and growth.
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="introduction-about">
        <h2>Introduction to AGAL</h2>
        <div class="introduction">
          <div class="intro-section left">
            <img src={img8} alt=" Image" class="intro-image" />
            <p>
              The Aquatech Genomic Agriculture Center (AGAL) is a pioneering
          ...
          <div class="intro-section right">
            ...
            <p>
              The Aquatech Genomic Agriculture Center (AGAL) is a
              ...
              environmental management. By integrating these technologies, AGAL
      ...
      <section class="goals">
        ...
        <div class="goal-container">
          ...
          <div class="goal-list">
            ...
            <Link to='/research'> <button style={{ margin: "20px 0 0 20px" }}>Discover More</button> </Link> 
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="team-members">
          <div class="member">
            ...
            <p>
              ...
              been instrumental in shaping AGAL's strategic direction and
          ...
          <div class="member">
            ...
            <p>
              ...
              has driven AGAL's technological advancements.
            </p>
            <div class="button-container">
              {/* <button class="bg-gray-500 text-white border-none px-4 py-2 rounded cursor-pointer hover:bg-gray-600">
                Know More
          ...
          <div class="member">
            ...
            <p>
              ...
              contributed to AGAL's research capabilities and impact.
            </p>
            <div class="button-container">
              {/* <button class="bg-gray-500 text-white border-none px-4 py-2 rounded cursor-pointer hover:bg-gray-600">
                Know More
        ...
        <div class="parent-company">
          <div class="parent-company-content">
            ...
            <div class="text-content">
              <p>
                AGAL operates under the aegis of Phoenix Labs, a leading biotech
                ...
                the establishment and growth of AGAL.
              </p>
             <Link to="/virtual"> <button class="bg-gray-500 text-white border-none px-4 py-2 rounded cursor-pointer hover:bg-gray-600">
                Explore More
              </button> </Link>
            </div>
          </div>
      ...
      <section class="question-section">
        <div class="overlay">
        <Link to='/contact'> <button class="bg-gray-500 text-white border-none px-4 py-2 rounded cursor-pointer hover:bg-gray-600">
            Let us Know
          </button> </Link>
          <Link to='/contact'> <button class="bg-gray-500 text-white border-none px-4 py-2 rounded cursor-pointer hover:bg-gray-600">
            Have any Questions?
