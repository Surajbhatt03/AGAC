...
const Virtual = () => {
  ...
  return (
    <div>
      <div className="overflow-x-hidden"> {/* Prevent horizontal overflow */}
        <header className="relative">
          <div className="bg-cover bg-center sm:h-24 md:h-64 lg:h-80 xl:h-96 w-full min-h-[6rem]" style={{ backgroundImage: `url(${event1})`, backgroundPosition: 'center top' }}>
    ...
    <div className="container mx-auto px-4 hover:cursor-pointer" onClick={clickHandler1}>
      <h2 className="text-3xl font-extrabold mb-4 text-center">Genomic Data Repository</h2>
      <p className="text-center mb-8 mt-4 text-lg text-gray-500 font-bold">
        AGAL's Genomic Data Repository is a secure, cloud-based platform for storing and accessing genomic data.
  ...
  {/* </a> */}
        ...
        <section className="py-8">
          <div className="container mx-auto px-4 hover:cursor-pointer" onClick={clickHandler2}>
        ...
        <section className="py-8 bg-white">
          <div className="container mx-auto px-4 hover:cursor-pointer" onClick={clickHandler3}>
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
              ...
              <div className="text-left">
                <h1 className="font-extrabold text-black text-3xl mb-4">AI in Agriculture</h1>
                ...
                <Link to="/courses/1">
                  <button className="bg-green-600 text-white px-5 py-2 rounded hover:bg-green-700">Enroll Now</button>
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
              ...
              />
              <div className="text-left">
                <h1 className="font-extrabold text-black text-3xl mb-4">Genetic Research</h1>
                <p className="text-gray-500 mb-2 text-md">
            ...
            <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
              ...
              />
              <div className="text-left">
                <h1 className="font-extrabold text-black text-3xl mb-4">Sustainable Farming Techniques</h1>
                <p className="text-gray-500 mb-2 text-md">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-36">
            ...
            <div className="w-full md:w-[300px] max-w-sm bg-white rounded-lg shadow-md overflow-hidden border border-green-600 mb-8 md:mb-0">
              ...
              <div className="p-4">
                ...
                <button className="bg-green-600 text-white px-6 py-2 rounded mt-6 hover:bg-green-700" onClick={clickHandler5}>Access</button>
              </div>
            </div>
            ...
            <div className="w-full md:w-[300px] max-w-sm bg-white rounded-lg shadow-md overflow-hidden border border-green-600 mb-8 md:mb-0">
              ...
              <div className="p-4">
                ...
                <button className="bg-green-600 text-white px-6 py-2 rounded mt-12 hover:bg-green-700"onClick={clickHandler5} >Access</button>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
                ...
                <div className="p-4 bg-white rounded-lg shadow mb-4 hover:cursor-pointer" onClick={clickHandler4}>
                ...
                <div className="p-4 bg-white rounded-lg shadow mb-4 hover:cursor-pointer" onClick={clickHandler2}>
