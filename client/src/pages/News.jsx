...
const News = () => {
  ...
  <div className="space-y-12">
    ...
    <div className="flex flex-col items-center border-b border-gray-200 pb-6 mb-6">
      ...
      <div className="w-full md:w-2/3 text-left">
        ...
        <button className="bg-green-600 mt-2 text-white px-4 py-2 rounded hover:bg-green-700" onClick={eventHandler}>Register Now</button>
      </div>
    </div>
    {/* Webinars */}
    <div className="flex flex-col items-center border-b border-gray-200 pb-6 mb-6">
    ...
    <div className="flex flex-col items-center border-b border-gray-200 pb-6 mb-6">
      ...
      <div className="w-full md:w-2/3 text-left">
        ...
        <button className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 mt-2" onClick={eventHandler}>Register Now</button>
      </div>
    </div>
    {/* Training Sessions */}
    <div className="flex flex-col items-center border-b border-gray-200 pb-6 mb-6">
  ...
  <div className="bg-white rounded-lg shadow-md p-8 border border-green-700 max-w-6xl mx-auto">
    ...
    <div
      ...
      className="text-green-600 text-md hover:underline hover:cursor-pointer"
    >
  ...
  <div className="flex flex-col items-center space-y-8">
    ...
    <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
      ...
      <div className="text-left sm:ml-6">
        ...
        <Link to="/media" className="text-green-600">Download Links : https://www.agal.com/media-kit</Link>
      </div>
    </div>
    {/* Media Kit 2 */}
    <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
    ...
    <div className="flex flex-col sm:flex-row items-center w-full max-w-4xl">
      ...
      <div className="text-left sm:ml-6">
        ...
        <Link to="/media"  className="text-green-600">Download Links : https://www.example.com/media-kit</Link>
      </div>
    </div>
  </div>
</section>
