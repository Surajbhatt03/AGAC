...
const SuccessStories = () => {
  ...
  const users = [
    ...
    {
      text: "Another user passage that explains their success story with AGAL. It's concise and to the point.",
      name: "John Doe",
      image: img2,
    },
    {
      text: "A different user's perspective highlighting the benefits they've gained from AGAL's services.",
      name: "Jane Smith",
      image: img3,
    },
  ];
    ...
    <section className="six-home">
      <div className="six-title">
        ...
        <div className="title-6">
          <h1>What They're Talking About AGAL</h1>
        </div>
