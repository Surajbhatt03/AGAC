...
import React from 'react';
import '../styles/Services.css';
>>>>>>> 81cc00e10491b66321f58a1c912f26309594cb64
        ...
        <div className="row">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Businesses and academic institutions can engage AGAC for custom
                research projects tailored to their specific needs and
                objectives. Our multidisciplinary team collaborates closely with
                clients to design and execute research that delivers impactful
                results.
              </p>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                AGAC provides a range of training programs, including workshops,
                seminars, and online courses. These programs educate
                professionals on the latest developments in AI, genetic
                research, and aquaculture techniques, supporting continuous
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                The Precision Nutrition System™ uses genetic and health data to
                develop personalized nutrition plans. These plans aim to
